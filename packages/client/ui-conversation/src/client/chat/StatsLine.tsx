...
import { DEFAULT_CNY_PRICING, formatCNY, priceBuckets } from './billing.ts'
...
export const StatsLine = memo(function StatsLine({ useSession, useProjection, t }: StatsLineProps) {
  ...
  if (usage !== undefined
    ...
    // The whole-log cost under the default DeepSeek CNY pricing; the billing
    // module is the single place to update prices.
    groups.push(t('stats.cost', { cost: formatCNY(priceBuckets(usage, DEFAULT_CNY_PRICING)) }))
  }
