...
export interface MessageIconActionsProps {
  ...
  /** This Turn's total cost, appended as `· 费用 ¥0.0042`; omitted when no usage was reported. */
  costCNY?: string | undefined
...
export function MessageIconActions({
  text, time, runMs, ttftMs, tokensPerSecond, costCNY, clock, onBranch, branchUnavailable = false, className,
  extraActions, t,
